...
PrimitiveAssembler::PrimitiveAssembler() : m_Vertices(nullptr), m_TextureCoordinates(nullptr), m_Colors(nullptr), m_Faces(nullptr) {}

PrimitiveAssembler::PrimitiveAssembler(std::vector<glm::vec4>& vertices, std::vector<glm::vec3>& textures, std::vector<Face>& faces)
    : m_Vertices(&vertices), m_TextureCoordinates(&textures), m_Faces(&faces) {}

PrimitiveAssembler::PrimitiveAssembler(std::vector<glm::vec4>& vertices, std::vector<glm::vec3>& textures,
...
std::vector<Triangle> PrimitiveAssembler::clipFarPlane(Triangle& triangle) {
    ...
    if (sum == 1) { // one vertex is clipped
        ...
        Color color1 = triangle.color[0] + (triangle.color[1] - triangle.color[0]) * t1;
        ...
        Color color2 = triangle.color[0] + (triangle.color[2] - triangle.color[0]) * t2;
    ...
    Color color1 = triangle.color[1] + (triangle.color[0] - triangle.color[1]) * t1;
    Triangle triangle1 = triangle;
    ...
    Color color2 = triangle.color[2] + (triangle.color[0] - triangle.color[2]) * t2;
...
std::vector<Triangle> PrimitiveAssembler::clipNearPlane(Triangle& triangle) {
...
std::vector<Triangle> PrimitiveAssembler::clip(Triangle& triangle) {
...
void PrimitiveAssembler::setVertices(std::vector<glm::vec4>& vertices) { m_Vertices = &vertices; }

void PrimitiveAssembler::setTextureCoordinates(std::vector<glm::vec3>& textures) { m_TextureCoordinates = &textures; }

void PrimitiveAssembler::setColors(std::vector<Color>& colors) { m_Colors = &colors; }

void PrimitiveAssembler::setFaces(std::vector<Face>& faces) { m_Faces = &faces; }

void PrimitiveAssembler::setViewport(glm::mat4& viewport) { m_Viewport = &viewport; }

void PrimitiveAssembler::processPrimitives() {
...
std::vector<Triangle>& PrimitiveAssembler::getTriangles() {
        return m_Triangles; 
    }