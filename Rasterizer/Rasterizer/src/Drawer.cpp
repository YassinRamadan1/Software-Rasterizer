...
float Drawer::calcMipmapLevel(fp46_16 du01, fp46_16 dv01, fp46_16 du10, fp46_16 dv10, fp46_16 width, fp46_16 height) {
...
void Drawer::setTriangles(std::vector<Triangle>& triangles) {
    m_Triangles = &triangles;
}

void Drawer::setTextureProcessor(TextureProcessor& textureProcessor) {
...
void Drawer::setRenderMode(RenderMode renderMode) {
    m_RenderMode = renderMode;
}

void Drawer::setProjectionMode(ProjectionMode projectionMode) {
    m_ProjectionMode = projectionMode;
}

void Drawer::setAttributeMode(AttributeMode attributeMode) {
